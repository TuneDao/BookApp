...
public class PdfDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //at start hide download button, because we need book url that we will load in function loadBookDetails()
        ...
        binding.readBookBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PdfDetailActivity.this, PdfViewActivity.class);//activity read book
        ...
        binding.downloadBookBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG_DOWNLOAD, "onClick: Kiểm tra quyền ");
                if(ContextCompat.checkSelfPermission(PdfDetailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Log.d(TAG_DOWNLOAD, "onClick: Quyền đã được cấp, có thể tải sách");
                    MyApplication.downloadBook(PdfDetailActivity.this,""+bookId,""+bookTitle,""+bookUrl);
                }else{
                    Log.d(TAG_DOWNLOAD, "onClick: Quyền không được cấp, yêu cầu cấp quyền...");
        ...
        binding.favoriteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(firebaseAuth.getCurrentUser()==null){
                    Toast.makeText(PdfDetailActivity.this, "Bạn chưa login tài khoản", Toast.LENGTH_SHORT).show();
                }else{
                    if(isInMyFavorite){
    ...
    private void addCommentDialog() {
        ...
        commentAddBinding.submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(comment)){
                    Toast.makeText(PdfDetailActivity.this, "Vui lòng nhập bình luận...", Toast.LENGTH_SHORT).show();
                }else {
                    alertDialog.dismiss();
                    addComment();
                }
        ...
        //handle click back dialog
        commentAddBinding.backDiaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onBackPressed();
            }
        ...
        ref.child(bookId).child("Comment").child(timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(PdfDetailActivity.this, "Bình luận thành công...", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfDetailActivity.this, "Bình luận thất bại"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private ActivityResultLauncher<String> resultLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(),isGranted ->{
                if(isGranted){
                    Log.d(TAG_DOWNLOAD, "Đã được cấp quyền ");
                    MyApplication.downloadBook(this,""+bookId,""+bookTitle,""+bookUrl);
                }else{
                    Log.d(TAG_DOWNLOAD, "Không được cấp quyền ...");
    ...
    private void checkIsFavorite(){
        ...
        reference.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        isInMyFavorite = snapshot.exists(); // true : if exisit, false if not exisit
                        if(isInMyFavorite){
                            //exisit in favorite
