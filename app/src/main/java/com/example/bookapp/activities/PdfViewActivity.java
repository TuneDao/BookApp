...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void loadBookDetails() {
        Log.d(TAG, "loadBookDetails: Đang lấy PDF từ database....");
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //B2 :load PDF using that url from firebase storage
    ...
    private void loadBookFromUrl(String pdfUrl) {
        Log.d(TAG, "loadBookFromUrl: Lấy PDF từ bộ nhớ");
                        ...
                        binding.pdfView.fromBytes(bytes)
                                ...
                                .onPageChange(new OnPageChangeListener() {
                                    ...
                                    public void onPageChanged(int page, int pageCount) {
                                        ...
                                        int currentPage = (page + 1);// do + 1 because start from 0
                                        binding.toolbarSubtitleTv.setText(currentPage + "/"+pageCount);//e.g : 3/200
